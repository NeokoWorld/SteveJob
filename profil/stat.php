...
echo '<link rel="stylesheet" href="stat.css">';
                    ...
                    <article class="prof"> Statistiques
                        <div style="width: 65%; margin:auto;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-11"><input type="Nombre" class="col-sm-6" placeholder="Nombre d\'offre crée"
                                        id="nombre offre-cree" required /></div>
                            </div>
                            <br>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-11"><input type="Nombre" class="col-sm-6" placeholder="Nombre d\'employés" 
                                    id="nbr_employes" required /></div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-sm-1">Code SIRET</div>
                                <div class="col-sm-11"><input type="Code" class="col-sm-6" placeholder="Code SIRET" 
                                    id="code-siret" required /></div>
                            </div>
                            <br>
                        </div>
                    </article>
